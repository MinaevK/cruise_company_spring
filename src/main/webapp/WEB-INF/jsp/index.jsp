...
<div class="row">
    <div class="col-md-4">
        <div class="panel-body">
            <ul class="list-group">
                <sec:authorize access="!isAuthenticated()">
                    <li class="list-group-item"><a href="${pageContext.request.contextPath}/login"><spring:message
                            code="button.login"/></a></li>
                    <li class="list-group-item"><a
                            href="${pageContext.request.contextPath}/registration"><spring:message
                            code="button.registrate"/></a></li>
                </sec:authorize>
                <sec:authorize access="hasRole('ROLE_ADMIN') and isAuthenticated()">
                    <li class="list-group-item"><a href="${pageContext.request.contextPath}/admin/admin"><spring:message
                            code="label.users"/></a></li>
                    <li class="list-group-item"><a
                            href="${pageContext.request.contextPath}/admin/all-applications"><spring:message
                            code="label.allApplications"/></a></li>
                    <li class="list-group-item"><a
                            href="${pageContext.request.contextPath}/admin/cruises"><spring:message
                            code="label.cruisesEditing"/></a></li>
                    <li class="list-group-item"><a href="${pageContext.request.contextPath}/admin/ships"><spring:message
                            code="label.shipsEditing"/></a></li>
                    <li class="list-group-item"><a
                            href="${pageContext.request.contextPath}/admin/cabins"><spring:message
                            code="label.cabinsEditing"/></a></li>
                </sec:authorize>
                <sec:authorize access="hasRole('ROLE_USER') and isAuthenticated()">
                    <li class="list-group-item"><a
                            href="${pageContext.request.contextPath}/user/booking"><spring:message
                            code="label.booking"/></a></li>
                    <li class="list-group-item"><a
                            href="${pageContext.request.contextPath}/user/user-applications"><spring:message
                            code="label.myApplications"/></a></li>
                </sec:authorize>
            </ul>
        </div>
    </div>
