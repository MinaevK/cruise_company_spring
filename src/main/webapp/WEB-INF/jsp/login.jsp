        ...
        <div class="user_card">
            ...
            <div class="d-flex justify-content-center form_container">
                <form method="POST" action="/login" class="">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="email" type="text" placeholder="<spring:message code = "placeholder.email"/>"
                               autofocus="true"/></div>
            ...
            <div class="mt-4">
                <div class="d-flex justify-content-center links">
                    <spring:message code="label.dontHaveAccount"/> <a href="/registration"><spring:message
                        code="button.registrate"/></a>
                </div>
            </div>
        </div>
    </div>
