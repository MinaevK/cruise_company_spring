...
<html>
<head>
    <title><spring:message code="title.cruise"/>: ${cruise.name}</title>
    <meta charset="utf-8">
...
<div class="container">
    <h3><spring:message code="label.Edit"/> ${cruise.name}</h3>
    <form:form method="post" modelAttribute="cruiseForm" class="form-inline">
    <div class="container">
        <div class="form-group">
            <label class="control-label col-md-2"><spring:message code="label.cruiseName"/>:</label>
        ...
        <table class="table">
            <h5><spring:message code="label.ports"/>: </h5>
